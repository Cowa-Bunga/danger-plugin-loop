...
function loop() {
    ...
    const testChanges = modifiedFiles.filter((filepath) => filepath.includes("test"));
    ...
    const testFilesThatDontExist = correspondingTestsForAppFiles.filter((f) => danger.github.utils.fileContents(f) && f.includes("dart"));
  ...
  `;
    ...
    markdown(`All new code should be in line with our [Coding Guidelines](http://dev-docs-bc10d.web.app)
